...
- 事業画像3枚は生成アート（`python3 site/assets/art/make_art.py` で再生成）。生成AI画像や実写に替えるときは `generated/` に置いて `python3 scripts/import_biz_images.py generated/*.png`（プロンプト集: `docs/image_prompts.md`）
